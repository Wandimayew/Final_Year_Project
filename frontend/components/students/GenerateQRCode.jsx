...
const GenerateQRCode = ({ onCloseGenQr, setOnCloseGenQr }) => {
  ...
  const handleSubmit = async (e) => {
    ...
    const qrcodeGenData = {
      ...
      generatedBy: e.target.generatedBy.value,
      generatedTime: e.target.generatedTime.value,
    ...
    <div className="fixed inset-0 bg-black bg-opacity-50 flex items-center justify-center p-4">
      <div className="w-full max-w-5xl mx-auto bg-white rounded-lg shadow-md p-6 overflow-auto">
        ...
        <form onSubmit={handleSubmit} className="grid grid-cols-2 gap-4">
          <InputField label="School ID" name="schoolId" />
          <InputField
            label="Select Class"
            name="classId"
            type="select"
          ...
          <InputField label="Generated By" name="generatedBy" />
