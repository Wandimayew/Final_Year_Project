            ...
            <div className="space-y-4">
              ...
              <div>
                ...
                <select
                  ...
                  onChange={(e) => isEditMode 
                    ? setSelectedFee({...selectedFee, isActive: e.target.value === 'true'})
                    : setNewFee({...newFee, isActive: e.target.value === 'true'})}
                >
                    ...
                    <div className="flex justify-between">
                      <div>
                        ...
                        <div className="mt-1 flex items-center gap-2">
                          ...
                          <span className={`text-xs px-2 py-1 rounded ${fee.isActive ? 'bg-green-100 text-green-800' : 'bg-red-100 text-red-800'}`}>
