...
public class PermissionCheckFilter extends OncePerRequestFilter {
    ...
    private final UserManagementClient userServiceClient;
    ...
    protected void doFilterInternal(HttpServletRequest request, HttpServletResponse response, FilterChain chain)
        ...
        try {
            ...
            log.info("Permission response is: {}", permissionResponse.isHasPermission()); // Corrected log
        ...
        log.info("Proceeding to next filter with Content-Type: {}", request.getContentType()); // Debug
        chain.doFilter(request, response);
    }
