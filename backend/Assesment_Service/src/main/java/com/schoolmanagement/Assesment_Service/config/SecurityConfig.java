package com.schoolmanagement.Assesment_Service.config;
    ...
    public SecurityFilterChain securityFilterChain(HttpSecurity http) throws Exception {
        http
                ...
                .authorizeHttpRequests(auth -> auth
                        ...
                        .requestMatchers("/api/assessment/**", "/api/assessment-analytics/**",
                                "/api/grades/**", "/api/progress-trackers/**","/api/report-cards/**")
                        .permitAll()
